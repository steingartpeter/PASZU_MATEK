...
CREATE TABLE `users` (
  `user_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Egy egyszerű int id',
  ...
  `usr_pwd` varchar(45) CHARACTER SET utf8 DEFAULT '9DE7681B968E3C7CB8064869063347E3857FB089' COMMENT 'A jelszó sha1',
  ...
  `usr_avatar_url` varchar(128) CHARACTER SET utf8 DEFAULT NULL COMMENT 'A felhasználó avatárjának képe',
  PRIMARY KEY (`user_id`),
  UNIQUE KEY `usr_name_UNIQUE` (`usr_name`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Bejelnetkezésre hivatott felhasználók alapadatai.';
...
INSERT INTO `users` VALUES (1,'peter.steingart@renault.hu','Péter','Steingart','F38B498ACA22ABD53C7316F73E8FB8A48865BD44','2019-02-18 12:23:48','2019-02-19 14:25:30','ax07057','fonok.jpg'),(2,'test.user@gmail.com','Elek','Teszt','9DE7681B968E3C7CB8064869063347E3857FB089','2019-02-19 13:29:48','2019-02-19 15:45:55','tesztelek01','tesztelek.jpg');
...
/*!50003 DROP PROCEDURE IF EXISTS `sp_UPDT_Lastlogin` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`ax07057`@`localhost` PROCEDURE `sp_UPDT_Lastlogin`(IN usrId INT, IN tm DATETIME)
    READS SQL DATA
    DETERMINISTIC
    COMMENT 'Last login frissítése'
BEGIN
-- <nn>
-- Leaírás a tárolt eljárás logikájáról, lépéseiról
    -- +-----------------------------------------------------------------------------+
...
UPDATE matekgyak.users SET usrlstlogin = tm WHERE user_id = usrId;
...
-- Dump completed on 2019-02-19 15:49:34
